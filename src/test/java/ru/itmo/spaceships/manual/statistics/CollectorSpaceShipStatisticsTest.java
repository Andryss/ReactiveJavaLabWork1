...
import ru.itmo.spaceships.statistics.CollectorSpaceShipStatistics;

@Slf4j
@Disabled("Только для ручного тестирования")
public class CollectorSpaceShipStatisticsTest extends BaseTimedStatisticsTest {

    public static final String REPORTS_BASE_PATH = "reports/CollectorSpaceShipStatistics/result";
