...
public class ManualSimpleManufacturerCounterStatisticsTest extends BaseTimedStatisticsTest {

    public static final String REPORTS_BASE_PATH = "reports/ManufacturerCounterStatistics/simple/result";
    ...
    void simpleSmallTest() {
        calculate(
                ...
                5_000,
                new SimpleManufacturerCounterStatistics(),
