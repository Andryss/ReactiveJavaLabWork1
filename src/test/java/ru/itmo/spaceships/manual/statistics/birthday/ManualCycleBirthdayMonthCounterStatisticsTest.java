...
import ru.itmo.spaceships.statistics.birthday.CycleBirthdayMonthCounterStatistics;

@Slf4j
@Disabled("Только для ручного тестирования")
public class ManualCycleBirthdayMonthCounterStatisticsTest extends BaseTimedStatisticsTest {

    public static final String REPORTS_BASE_PATH = "reports/BirthdayMonthCounter/cycle/result";
    ...
    void streamSmallTest() {
        calculate(
                ...
                5_000,
                new CycleBirthdayMonthCounterStatistics(),
